...
Route::group(['prefix' => LaravelLocalization::setLocale()], function () {
    Route::prefix('dashboard')->group(function () {
        ...
        Route::prefix('contact')->group(function () {
            Route::get('/contactSetting/edit', [ContactSettingController::class, 'editContactSetting'])->name('editContactSetting');
            Route::post('/contactSetting/update', [ContactSettingController::class, 'updateContactSetting'])->name('updateContactSetting');
        });
