                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <h5 class="card-title mb-0 col-sm-8 col-md-10">Archive Duration List</h5>
                                <!-- Load More Buttons -->
                                <div class="hstack flex-wrap gap-2   mb-lg-0 mb-0 col-sm-2 col-md-1">
                                    <a href="{{ route('duration.addDuration') }}" class="btn btn-outline-secondary btn-load">
                            ...
                            <table id="alternative-pagination"
                                ...
                                <tbody class="text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $duration->num_weeks }}</td>
                                        <td>
                                            <a href="{{ route('duration.restore',$duration->id) }}"> <i class="bx bx-revision btn btn-success"></i></a>
