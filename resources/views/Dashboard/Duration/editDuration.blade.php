                    ...
                    <div class="card-header">
                        ...
                        <div class="card-body ">
                            <div class="listjs-table" id="customerList">
                                ...
                                <form action="{{ route('duration.update', ['id' => $id->id]) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="titleEnInput" class="form-label">Number Of Weeks</label>
                                                <input type="text" class="form-control" name="num_weeks" placeholder="Number Of Weeks" id="titleEnInput" value="{{$id->num_weeks }}">
                                            </div>
                                        </div><!--end col-->
