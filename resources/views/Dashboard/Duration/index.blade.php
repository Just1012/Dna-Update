                            ...
                            <table id="alternative-pagination"
                                ...
                                <tbody class="text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('duration.edit', ['id' => $duration->id]) }}"> <i class="bx bxs-edit btn btn-warning"></i></a>
                                            <a href="{{ route('duration.archive', ['id' => $duration->id]) }}"> <i class="bx bx-archive-in btn btn-primary"></i></a>
                                        </td>
