                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-shrink-0 mt-sm-0 mt-3">
                                                ...
                                                <h6>
                                                    ...
                                                    <span id="email">{{ $order->Duration->{'title_' . App::getLocale()} }}</span>
                                                </h6>
                                                <h6>
                                    ...
                                    <div class="card-body p-4">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-lg-2 col-6">
                                                ...
                                                <h5 class="fs-14 mb-0"><span id="total-amount">{{ $order->Program->{'title_' . App::getLocale()} }}</span>
                                                </h5>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-2 col-6">
                                            ...
                                            @endphp
                                                    <div class="col-md-6 mt-sm-5 mt-4">
                                                        ...
                                                        <p class="text-muted mb-1" id="address-details">
                                                          {{ $governorateName->title }} - {{ $areaName->area }} <br> {{ $value->Address->address }}</p>
