                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-shrink-0 mt-sm-0 mt-3">
                                                ...
                                                <h6>
                                                    ...
                                                    <span
                                                        id="email">{{ $order->Duration->{'title_' . App::getLocale()} }}</span>
                                                </h6>
                                                <h6>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-lg-2 col-6">
                                                ...
                                                <h5 class="fs-14 mb-0"><span
                                                        id="total-amount">{{ $order->Program->{'title_' . App::getLocale()} }}</span>
                                                </h5>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-2 col-6">
                                                ...
                                                @foreach ($order->OrderDays as $value)
                                                    @php
                                                        ...
                                                        $shipping_notes = DB::table('shipping_notes')
                                                            ->where('id', $value->Address->shipping_notes)
                                                    ...
                                                    <div class="col-md-6 mt-sm-5 mt-4">
                                                        ...
                                                        <p class="text-muted mb-1" id="address-details">
                                                            <span>{{ __('messages.address_note') }}: </span>
                                                            {{ $value->Address->address }}
                                                        </p>

                                                        @if ($shipping_notes)
                                                            <p class="text-muted mb-1" id="address-details">
                                                                <span>{{ __('messages.shipping_notes') }}: </span>
