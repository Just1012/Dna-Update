                                    ...
                                    <div class="col-sm-auto">
                                        <div>
                                            <a class="btn btn-success add-btn" id="create-btn"
                                                ...
                                                @else
                                                {{ route('category.index',$id->parent_id) }}
                                                @endif">Back</a>
                                        </div>
                                    </div>
                                </div>
                                <form action="{{ route('category.update', ['id' => $id->id]) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="file" class="form-control" name="image" id="address1ControlTextarea"
                                                        value="{{ isset($id->image) ? $id->image : old('image') ?? '' }}">
                                            </div>
                                        </div><!--end col-->
