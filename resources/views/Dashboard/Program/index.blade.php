                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <h5 class="card-title mb-0 col-sm-8 col-md-10">Program List</h5>

                                <div class="hstack flex-wrap gap-2   mb-lg-0 mb-0 col-sm-2 col-md-1">
                                    <a href="{{ route('program.addProgram') }}" class="btn btn-outline-secondary btn-load">
        ...
        var table = $('#alternative-pagination').DataTable({
            ...
            columns: [
...

                {
                    'data': null,
                    render: function(data) {
                        var programUrl = '{{ route('program.details', ':id') }}';
                        var editUrl = '{{ route('program.editProgram', ':id') }}';
                        var deleteUrl = '{{ route('program.archive', ':id') }}';

                        programUrl = programUrl.replace(':id', data.id);
                        ...
                        var programsButton = '<a href="' + programUrl +
                            '"> <i class="bx bx-show btn btn-success"></i></a>';

                        return programsButton + '' + editButton + '' + deleteButton;
                    }
                },
