            ...
            columns: [{
...

                {
                    ...
                    render: function(data) {
                        ...
                        var deleteButton =
                            '<button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#topmodal" data-id="' +
                            data.id + '"><i class="bx bx-trash"></i></button>';
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#topmodal').on('show.bs.modal', function(event) {
                ...
                var deleteUrl = '{{ route('slider.delete', ':id') }}'; // Use the route with a placeholder
