                            ...
                            <table id="alternative-pagination"
                                ...
                                <tbody class="text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('meals.restore',$meal->id) }}"> <i class="bx bx-revision btn btn-success"></i></a>
                                            {{-- <a href="{{ route('meal.archive', ['id' => $meal->id]) }}"> <i class="bx bx-trash btn btn-danger"></i></a> --}}
                                        </td>
