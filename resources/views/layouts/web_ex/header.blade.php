        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <form class="app-search d-none d-md-block">
                    <div class="position-relative">
                        <input type="text" class="form-control" placeholder="بحث" autocomplete="off"
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        id="languageDropdownBtn" data-bs-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
                        <img id="header-lang-img" src="{{ asset('web/assets/images/loading.webp') }}"
                            alt="Header Language" height="20" class="rounded">
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            <a class="dropdown-item notify-item language py-2"
                                href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}"
                                data-locale="{{ $localeCode }}">
                                <img src="{{ asset('web/assets/images/flags/' . $properties['native']) . '.svg' }}"
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{ route('profile.index', ['id' => auth()->user()->id]) }}"><i
