            ...
            <div class="details">
                <div class="info d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <h3 class="program-title">{{ App::getLocale() == 'ar' ? $programsDetails->title_ar :
                            $programsDetails->title_en }}</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row tiles_radio">
                ...
                <div class="col-md-3 col-6 my-2">
                    <div>
                        ...
                        <label for="duration{{ $duration['duration_id'] ?? 0 }}" class="d-flex align-items-center p-2">
